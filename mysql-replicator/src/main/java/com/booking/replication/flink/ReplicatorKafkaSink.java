...
/**
 * This class is just a simple wrapper for FlinkKafkaProducer
 */
public class ReplicatorKafkaSink extends FlinkKafkaProducer<AugmentedEvent> {
    ...
    public ReplicatorKafkaSink(Map<String,Object> configuration) {
