...
public class WriteRowsAugmentedEventData implements TableAugmentedEventData {
    ...
    public WriteRowsAugmentedEventData(AugmentedEventTable eventTable, List<Boolean> includedColumns, List<AugmentedEventColumn> columns, List<Serializable[]> rows) {
