...
public class SchemaUtil {
    ...
    private static Integer getColumnCollationIdForEnumAndSet(TableMapEventMetadata tableMapEventMetadata, int columnIndex, int enumAndSetCharsetIdIndex) {
