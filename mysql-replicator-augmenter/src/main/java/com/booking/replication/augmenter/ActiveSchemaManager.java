...
public class ActiveSchemaManager implements SchemaManager {
    ...
    public boolean createDbIfNotExists(Map<String, Object> configuration) {
        ...
        try (Connection conn = dataSource.getConnection()) {
            try(PreparedStatement stmt = conn.prepareStatement("SHOW DATABASES LIKE ?")) {
                ...
                try(PreparedStatement createDb = conn.prepareStatement("CREATE DATABASE " + schema)) {
    ...
    public boolean execute(String tableName, String query) {
        ...
        try (Connection connection = this.dataSource.getConnection();
            ...
            LOG.warn(String.format("error executing query \"%s\": %s", query, exception.getMessage()));
            return false;
        }
    }
    ...
    public String getCreateTable(String tableName) {
        try (Connection connection = this.dataSource.getConnection();
            ...
            LOG.warn(String.format("error getting create table from table \"%s\"", tableName), exception.getMessage());
            return null;
        }
    }
