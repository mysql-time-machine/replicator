...
public class DeleteRowsEventHandler implements RawBinlogEventHandler {
    ...
    @Override
    public void apply(IBinlogEvent binlogEvent, CurrentTransaction currentTransaction) throws EventHandlerApplyException, TableMapException, ApplierException, IOException, RowListMessageSerializationException, KafkaMessageBufferException {
