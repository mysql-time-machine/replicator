...
public class MySQLRunner {
    ...
    public boolean runMysqlScript(MySQLContainer mysqlContainer,
                                  MySQLConfiguration configuration,
                                  String scriptFilePath,
                                  Map<String, String> scriptParams,
                                  boolean runAsRoot) {
        BasicDataSource dataSource = initDatasource(mysqlContainer, configuration, Driver.class.getName(), runAsRoot);
    ...
    public List<HashMap<String, Object>> runMysqlQuery(MySQLContainer mysqlContainer,
                                                       MySQLConfiguration configuration,
                                                       String query,
                                                       boolean runAsRoot) {
        BasicDataSource dataSource = initDatasource(mysqlContainer, configuration, Driver.class.getName(), runAsRoot);
    ...
    private BasicDataSource initDatasource(MySQLContainer mysqlContainer,
                                           MySQLConfiguration configuration,
                                           Object driverClass,
                                           boolean runAsRoot) {
        String hostname = mysqlContainer.getHost();
        Object port = mysqlContainer.getPort();
