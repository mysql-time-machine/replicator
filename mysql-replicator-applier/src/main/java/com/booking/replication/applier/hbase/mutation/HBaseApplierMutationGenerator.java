        ...
        switch (augmentedRow.getEventType()) {
            ...
            case DELETE: {
                ...
                this.metrics.getRegistry()
                        .counter("replicator.applier.hbase.columns.mutations.count").inc(1L);
                this.metrics.getRegistry()
                        .counter("replicator.applier.hbase.columns.mutations.delete.count").inc(1L);
                ...
                for (String columnName : augmentedRow.getValues().keySet()) {
                    ...
                    if ((valueAfter == null) && (valueBefore == null)) {
                        ...
                        this.metrics.getRegistry()
                                .counter("replicator.applier.hbase.columns.mutations.count").inc(1L);
                        this.metrics.getRegistry()
                                .counter("replicator.applier.hbase.columns.mutations.update.count").inc(1L);
            ...
            case INSERT: {
                ...
                for (String columnName : augmentedRow.getValues().keySet()) {
                    ...
                    this.metrics.getRegistry()
                            .counter("replicator.applier.hbase.columns.mutations.count").inc(1L);
                    this.metrics.getRegistry()
                            .counter("replicator.applier.hbase.columns.mutations.insert.count").inc(1L);
                }
