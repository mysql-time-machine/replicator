...
public class CellValueDeserializerTest {
    ...
    public void deserializeTinyInt() throws Exception {
        ColumnSchema columnSchema = new ColumnSchema("id", DataType.TINYINT, "tinyint(3) unsigned", "NULL", false, "", "NULL", "");
        HashMap<String, String[]> cache = new HashMap<>();
        Object result = CellValueDeserializer.deserialize(cache, columnSchema, -35, "NULL");
        assertEquals(221, result);

        ColumnSchema columnSchema1 = new ColumnSchema("id", DataType.TINYINT, "tinyint(3) unsigned", "NULL", false, "", "NULL", "");
        ...
        ColumnSchema columnSchema2 = new ColumnSchema("id", DataType.TINYINT, "tinyint(3)", "NULL", false, "PRI", "NULL", "");
    ...
    public void deserializeSmallInt() throws Exception {
        ColumnSchema columnSchema = new ColumnSchema("id", DataType.SMALLINT, "smallint(10) unsigned", "NULL", false, "PRI", "NULL", "");
        HashMap<String, String[]> cache = new HashMap<>();
        Object result = CellValueDeserializer.deserialize(cache, columnSchema, -32768, "NULL");
        assertEquals(32768, result);

        ColumnSchema columnSchema1 = new ColumnSchema("id", DataType.SMALLINT, "smallint(10) unsigned", "NULL", false, "PRI", "NULL", "");
        HashMap<String, String[]> cache1 = new HashMap<>();
        Object result1 = CellValueDeserializer.deserialize(cache1, columnSchema1, -32766, "NULL");
        assertEquals(32770, result1);

        ColumnSchema columnSchema2 = new ColumnSchema("id", DataType.SMALLINT, "smallint(10)", "NULL", false, "PRI", "NULL", "");
        HashMap<String, String[]> cache2 = new HashMap<>();
    ...
    public void deserializeMediumInt() throws Exception {
        ColumnSchema columnSchema = new ColumnSchema("id", DataType.MEDIUMINT, "mediumint(10) unsigned", "NULL", false, "PRI", "NULL", "");
        HashMap<String, String[]> cache = new HashMap<>();
        Object result = CellValueDeserializer.deserialize(cache, columnSchema, -8388608, "NULL");
        assertEquals(8388608, result);

        ColumnSchema columnSchema1 = new ColumnSchema("id", DataType.MEDIUMINT, "mediumint(10) unsigned", "NULL", false, "PRI", "NULL", "");
        HashMap<String, String[]> cache1 = new HashMap<>();
        Object result1 = CellValueDeserializer.deserialize(cache1, columnSchema1, -8388607, "NULL");
        assertEquals(8388609, result1);

        ColumnSchema columnSchema2 = new ColumnSchema("id", DataType.MEDIUMINT, "mediumint(10)", "NULL", false, "PRI", "NULL", "");
        HashMap<String, String[]> cache2 = new HashMap<>();
    ...
    public void deserializeInt() throws Exception {
        ColumnSchema columnSchema = new ColumnSchema("id", DataType.INT, "int(10) unsigned", "NULL", false, "PRI", "NULL", "");
        HashMap<String, String[]> cache = new HashMap<>();
        Object result = CellValueDeserializer.deserialize(cache, columnSchema, -2147483648, "NULL");
        assertEquals(2147483648L, result);

        ColumnSchema columnSchema1 = new ColumnSchema("id", DataType.INT, "int(10) unsigned", "NULL", false, "PRI", "NULL", "");
        HashMap<String, String[]> cache1 = new HashMap<>();
        Object result1 = CellValueDeserializer.deserialize(cache1, columnSchema1, -2147483647, "NULL");
        assertEquals(2147483649L, result1);

        ColumnSchema columnSchema2 = new ColumnSchema("id", DataType.INT, "int(10)", "NULL", false, "PRI", "NULL", "");
        HashMap<String, String[]> cache2 = new HashMap<>();
    ...
    public void deserializeBigInt() throws Exception {
        ColumnSchema columnSchema = new ColumnSchema("id", DataType.BIGINT, "bigint(10) unsigned", "NULL", false, "PRI", "NULL", "");
        HashMap<String, String[]> cache = new HashMap<>();
        ...
        ColumnSchema columnSchema1 = new ColumnSchema("id", DataType.BIGINT, "bigint(10) unsigned", "NULL", false, "PRI", "NULL", "");
        HashMap<String, String[]> cache1 = new HashMap<>();
        ...
        ColumnSchema columnSchema2 = new ColumnSchema("id", DataType.BIGINT, "bigint(10)", "NULL", false, "PRI", "NULL", "");
        HashMap<String, String[]> cache2 = new HashMap<>();
        Object result2 = CellValueDeserializer.deserialize(cache2, columnSchema2, 8388600, "NULL");
        assertEquals(8388600, result2);

        ColumnSchema columnSchema3 = new ColumnSchema("id", DataType.BIGINT, "bigint(10) unsigned", "NULL", false, "PRI", "NULL", "");
    ...
    public void deserializeString() throws Exception {
        ...
        ColumnSchema columnSchema = new ColumnSchema("name", DataType.CHAR, "char(2)", "latin1_swedish_ci", true, "", "NULL", "");
        HashMap<String, String[]> cache = new HashMap<>();
        Object result = CellValueDeserializer.deserialize(cache, columnSchema, "fr".getBytes(), "NULL");
        assertEquals("fr", result);

        ColumnSchema columnSchema1 = new ColumnSchema("name", DataType.VARCHAR, "varchar(255)", "utf8_general_ci", true, "", "NULL", "");
        HashMap<String, String[]> cache1 = new HashMap<>();
        Object result1 = CellValueDeserializer.deserialize(cache1, columnSchema1, "foobar".getBytes(), "NULL");
        assertEquals("foobar", result1);

        ColumnSchema columnSchema3 = new ColumnSchema("name", DataType.VARCHAR, "varchar(255)", "utf8_general_ci", true, "", "NULL", "");
        HashMap<String, String[]> cache3 = new HashMap<>();
        Object result3 = CellValueDeserializer.deserialize(cache3, columnSchema3, "sÃƒÂ¥".getBytes(), "NULL");
        assertEquals("sÃƒÂ¥", result3);

        ColumnSchema columnSchema2 = new ColumnSchema("name", DataType.MEDIUMTEXT, "mediumtext(255)", "utf8_general_ci", true, "", "NULL", "");
        HashMap<String, String[]> cache2 = new HashMap<>();
    ...
    public void deserializeBinary() throws Exception {
        ColumnSchema columnSchema = new ColumnSchema("name", DataType.BINARY, "binary", "NULL", true, "", "NULL", "");
        HashMap<String, String[]> cache = new HashMap<>();
        ...
        ColumnSchema columnSchema1 = new ColumnSchema("name", DataType.BINARY, "binary", "NULL", true, "", "NULL", "");
        HashMap<String, String[]> cache1 = new HashMap<>();
        ...
        ColumnSchema columnSchema2 = new ColumnSchema("name", DataType.BINARY, "binary", "NULL", true, "", "NULL", "");
        HashMap<String, String[]> cache2 = new HashMap<>();
        ...
        ColumnSchema columnSchema3 = new ColumnSchema("name", DataType.BINARY, "binary(4)", "NULL", true, "", "NULL", "");
        HashMap<String, String[]> cache3 = new HashMap<>();
    ...
    public void deserializeColumnTypeWithMysqlKeywords() throws Exception {
        ColumnSchema columnSchema = new ColumnSchema("name", DataType.ENUM, "enum('boolean','integer','string','date','datetime','boolarray','intarray','stringarray','datearray','enum')", "NULL", true, "", "string", "");
        HashMap<String, String[]> cache = new HashMap<>();
    ...
    public void deserializeUnhandled() throws Exception {
        ...
        ColumnSchema columnSchema = new ColumnSchema("name", DataType.JSON, "json", "NULL", true, "", "NULL", "");
        HashMap<String, String[]> cache = new HashMap<>();
