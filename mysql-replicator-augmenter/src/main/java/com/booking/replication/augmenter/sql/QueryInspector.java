...
import com.booking.replication.supplier.model.QueryEventData;
...
public class QueryInspector {
    ...
    private static class  QueryPatterns {
    ...
    public static QueryEventType getQueryEventType(QueryEventData event) {
